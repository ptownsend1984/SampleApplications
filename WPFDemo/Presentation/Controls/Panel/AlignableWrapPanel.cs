...
namespace WPFDemo.Presentation.Controls.Panel
{
    //From http://stackoverflow.com/questions/806777/wpf-how-can-i-center-all-items-in-a-wrappanel
    public class AlignableWrapPanel : System.Windows.Controls.Panel
    {
        ...
        public static readonly DependencyProperty MaxItemsInLineProperty =
            DependencyProperty.Register("MaxItemsInLine", typeof(int), typeof(AlignableWrapPanel), new FrameworkPropertyMetadata(0, FrameworkPropertyMetadataOptions.AffectsArrange));
        ...
        {
            get { return (int)GetValue(MaxItemsInLineProperty); }
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            var MaxItemsInLine = this.MaxItemsInLine;
            ...
            for (int i = 0; i < children.Count; i++)
            {
                ...
                if (curLineSize.Width + sz.Width > constraint.Width || (MaxItemsInLine > 0 && numInLine == MaxItemsInLine)) //need to switch to another line
                {
        ...
        protected override Size ArrangeOverride(Size arrangeBounds)
        {
            ...
            for (int i = 0; i < children.Count; i++)
            {
                ...
                if (curLineSize.Width + sz.Width > arrangeBounds.Width || (MaxItemsInLine > 0 && numInLine == MaxItemsInLine)) //need to switch to another line
                {
